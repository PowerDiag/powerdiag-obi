...
| Magenta | blink, 2 s | No usable answer (all `0x00` / all `0xFF`) — check the pack is seated |
...
**BTN2 shows nothing while held.** It dismisses the latched result after a **1 s** hold, and the LED
