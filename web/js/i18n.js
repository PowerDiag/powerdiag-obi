...
const STRINGS = {
  ...
  'zh-TW': {
    ...
    'field.manufactured': '製造日期', 'field.romId': 'ROM ID', 'field.message': '電池訊息',
  ...
  ko: {
    ...
    'field.manufactured': '제조일', 'field.romId': 'ROM ID', 'field.message': '배터리 메시지',
  ...
  vi: {
    ...
    'btn.copy': 'Sao chép kết quả', 'group.test': 'Kiểm tra chức năng', 'group.write': 'Ghi vào pin', 'status.copied': 'Đã sao chép',
    ...
    'field.manufactured': 'Ngày sản xuất', 'field.romId': 'ROM ID', 'field.message': 'Bản tin từ pin',
    'field.terminalVoltage': 'Điện áp pack (đo được)', 'field.packVoltage': 'Điện áp pack (BMS)',
    'field.cell': 'Cell', 'field.cellDiff': 'Chênh lệch điện áp cell',
    'field.tempCell': 'Cảm biến nhiệt độ 1', 'field.tempMosfet': 'Cảm biến nhiệt độ 2',
    'state.locked': 'ĐÃ KHÓA', 'state.unlocked': 'BÌNH THƯỜNG',
    'sec.identity': 'Thông tin nhận dạng', 'sec.voltages': 'Điện áp', 'sec.log': 'Nhật ký giao tiếp',
  ...
  th: {
    ...
    'btn.copy': 'คัดลอกผลอ่าน', 'group.test': 'ทดสอบการทำงาน', 'group.write': 'เขียนลงแบตเตอรี่', 'status.copied': 'คัดลอกแล้ว',
    ...
    'field.manufactured': 'วันที่ผลิต', 'field.romId': 'ROM ID', 'field.message': 'ข้อความจากแบตเตอรี่',
    'field.terminalVoltage': 'แรงดันแพ็ก (วัดจริง)', 'field.packVoltage': 'แรงดันแพ็ก (BMS)',
    ...
    'sec.identity': 'ข้อมูลระบุตัวตน', 'sec.voltages': 'แรงดันไฟฟ้า', 'sec.log': 'บันทึกการสื่อสาร',
    'log.show': 'แสดงบันทึก', 'log.hide': 'ซ่อนบันทึก', 'log.clear': 'ล้าง', 'log.export': 'ส่งออก',
