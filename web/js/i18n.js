...
const STRINGS = {
  ...
  zh: {
    ...
    'field.terminalVoltage': '端子电压（实测）', 'field.packVoltage': '电池组电压',
  ...
  'zh-TW': {
    ...
    'field.terminalVoltage': '端子電壓（實測）', 'field.packVoltage': '電池組電壓',
  ...
  ko: {
    ...
    'btn.copy': '결과 복사', 'group.test': '동작 테스트', 'group.write': '배터리에 기록', 'status.copied': '복사했습니다',
    'status.idle': '연결되지 않음', 'status.connecting': '연결 중…', 'status.connected': '연결됨',
    ...
    'field.terminalVoltage': '단자 전압 (실측)', 'field.packVoltage': '팩 전압',
    ...
    'note.charge': '* 충전 횟수는 읽어 추정한 값이며 제조사의 공식 수치가 아닙니다.',
  ...
  vi: {
    ...
    'field.terminalVoltage': 'Điện áp đầu cực (đo được)', 'field.packVoltage': 'Điện áp pack',
  ...
  th: {
    ...
    'field.terminalVoltage': 'แรงดันที่ขั้ว (วัดจริง)', 'field.packVoltage': 'แรงดันแพ็ก',
