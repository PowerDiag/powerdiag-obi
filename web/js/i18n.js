...
const STRINGS = {
  ...
  zh: {
    ...
    'btn.copy': '复制读数', 'group.test': '功能测试', 'group.write': '写入电池', 'status.copied': '已复制',
  ...
  'zh-TW': {
    ...
    'btn.copy': '複製讀數', 'group.test': '功能測試', 'group.write': '寫入電池', 'status.copied': '已複製',
    ...
    'field.terminalVoltage': '端子電壓（實測）', 'field.packVoltage': '整包電壓',
